...
export const { indexPage, animePage, getList, searchAnime, getAnimeInfo, getPopularBanner, getAnimeBanner, getAnimeTitle, searchGenre, watchPage, getAnimeByIds, } = aniSdk(aniListClient);
...
export const { getAnimesKitsu, getEpisodeKitsu } = kitsuSdk(kitsuClient, kitsuMiddleware);
/**
