...
The server uses Express.js with TypeScript and follows a service-oriented architecture:
...
- **Production Database**: MongoDB with Mongoose for schema management and data operations
- **Development Storage**: In-memory storage implementation as fallback when MongoDB is unavailable
- **Database Provider**: MongoDB (configurable via MONGODB_URI environment variable)
