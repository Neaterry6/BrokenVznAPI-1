...
describe('Environment Configuration', () => {
    ...
    describe('Configuration Validation', () => {
        ...
        it('should handle missing Firebase configuration gracefully', () => {
            ...
            // Firebase can be omitted in tests because storage falls back to memory.
            expect(() => {
                if (!firebaseProjectId && !firebaseServiceAccount && !firebaseApiKey) {
                    console.warn('No Firebase configuration found, using in-memory storage');
                }
            }).not.toThrow();
        });
    });
