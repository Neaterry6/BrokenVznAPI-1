...
export class TranscriptionService {
    ...
    async uploadFile(file) {
        ...
        const response = await axios.post(`${this.baseUrl}/upload`, file.buffer, { headers });
        return response.data.upload_url;
    }
    async submitTranscription(audioUrl, language) {
        const headers = {
            'authorization': this.apiKey,
    ...
    // Transcribe from URL
    async transcribeFromUrl(url, language = 'en') {
