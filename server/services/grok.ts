...
export class GrokService {
  ...
  async chatWithImage(request: GrokImageRequest): Promise<GrokResponse> {
    try {
      if (!openai) {
        return {
          success: true,
  ...
  async summarizeText(text: string): Promise<GrokResponse> {
    try {
      if (!openai) {
        return {
          success: true,
  ...
  async analyzeSentiment(text: string): Promise<GrokResponse> {
    try {
      if (!openai) {
        return {
          success: true,
