...
export class GeminiService {
    ...
    async summarizeText(text, model = "gemini-2.5-flash") {
    ...
    async analyzeSentiment(text, model = "gemini-2.5-pro") {
        try {
    ...
    async generateImage(prompt) {
        try {
            ...
            let imageUrl = "https://placehold.co/600x400?text=Image+Generation+Failed";
            let description = "";
