...
export class UtilitiesService {
  ...
  async base64Operation(request: Base64Request): Promise<UtilityResponse> {
    try {
      if (!request.text) {
        return {
          success: false,
  ...
  async generateHash(request: HashRequest): Promise<UtilityResponse> {
    try {
  ...
  async generateUUID(): Promise<UtilityResponse> {
    try {
  ...
  async urlShorten(originalUrl: string, customAlias?: string): Promise<UtilityResponse> {
    try {
  ...
  async textStatistics(text: string): Promise<UtilityResponse> {
    try {
      const stats = {
        ...
        mostCommonWords: [] as { word: string; count: number }[]
      };
...
export class ToolsUtilityService {
  ...
  async encodeBase64(request: { query: string }): Promise<UtilityResponse> {
    try {
      if (!request.query) {
        return {
          success: false,
  ...
  async decodeBase64(request: { query: string }): Promise<UtilityResponse> {
    try {
      if (!request.query) {
        return {
          success: false,
  ...
  async encodeBinary(request: { query: string }): Promise<UtilityResponse> {
    try {
      if (!request.query) {
        return {
          success: false,
  ...
  async decodeBinary(request: { query: string }): Promise<UtilityResponse> {
    try {
      if (!request.query) {
        return {
          success: false,
  ...
  async generateMD5(request: { query: string }): Promise<UtilityResponse> {
    try {
      if (!request.query) {
        return {
          success: false,
  ...
  async generateSHA256(request: { query: string }): Promise<UtilityResponse> {
    try {
      if (!request.query) {
        return {
          success: false,
  ...
  async obfuscateJS(request: { query: string }): Promise<UtilityResponse> {
    try {
      if (!request.query) {
        return {
          success: false,
