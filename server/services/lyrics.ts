...
export class LyricsService {
  ...
  private async scrapeLyricsFromGenius(artist: string, title: string): Promise<string | null> {
    try {
  ...
  private async scrapeLyricsFromAZLyrics(artist: string, title: string): Promise<string | null> {
    try {
