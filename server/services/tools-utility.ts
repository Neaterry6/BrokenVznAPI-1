...
export class ToolsUtilityService {
  ...
  // Base64 encoding
  async encodeBase64(request: ToolsRequest): Promise<ToolsResponse> {
    try {
      const { query } = request;
  ...
  // Base64 decoding
  async decodeBase64(request: ToolsRequest): Promise<ToolsResponse> {
    try {
      const { query } = request;
  ...
  // Binary encoding
  async encodeBinary(request: ToolsRequest): Promise<ToolsResponse> {
    try {
      const { query } = request;
  ...
  // Binary decoding
  async decodeBinary(request: ToolsRequest): Promise<ToolsResponse> {
    try {
      const { query } = request;
      ...
      const decoded = query.split(' ').map(binary => 
  ...
  async obfuscateJS(request: ToolsRequest): Promise<ToolsResponse> {
    try {
      const { query } = request;
  ...
  // MD5 Hash
  async generateMD5(request: ToolsRequest): Promise<ToolsResponse> {
    try {
      const { query } = request;
  ...
  // SHA256 Hash
  async generateSHA256(request: ToolsRequest): Promise<ToolsResponse> {
    try {
      const { query } = request;
