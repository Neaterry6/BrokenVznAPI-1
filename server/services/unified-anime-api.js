...
export class UnifiedAnimeAPI {
    ...
    // Get anime details
    async getAnimeDetails(animeId, source = 'gogoanime') {
        try {
    ...
    // GogoAnime details
    async getGogoAnimeDetails(animeId) {
        try {
    ...
    // Get episodes list
    async getGogoAnimeEpisodes(movieId, animeId) {
        try {
            if (!movieId)
                return [];
    ...
    // AnimePahe details
    async getAnimePaheDetails(animeId) {
        try {
    ...
    async getAnimePaheEpisodes(animeId) {
        try {
    ...
    // Get streaming links
    async getStreamingLinks(episodeId, source = 'gogoanime') {
        try {
            switch (source.toLowerCase()) {
                case 'gogoanime':
    ...
    // GogoAnime streaming
    async getGogoAnimeStreaming(episodeId) {
        try {
    ...
    // AnimePahe streaming
    async getAnimePaheStreaming(episodeId) {
        try {
