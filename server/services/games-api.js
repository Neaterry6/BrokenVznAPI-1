...
export const gamesService = {
    async trivia(amount = 10, category = '', difficulty = '') {
        try {
            ...
            return { results: [], error: 'Trivia unavailable' };
        }
    },
    async wordGame(type = 'scramble') {
        try {
            ...
            return { error: 'Word game unavailable' };
        }
    },
    async numberFact(number) {
        try {
            ...
            return { error: 'Number fact unavailable' };
        }
    },
